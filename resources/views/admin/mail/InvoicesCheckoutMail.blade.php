                    ...
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">سداد فاتورة</h2>

                            <p>عميلنا العزيز بناء علي طلبك قمنا بارسال هذه الفاتورة اليك , يمكنك فتح الرابط التالي لاستكمال عملية الدفع</p>

                            <a href="{{ $info['link'] }}"
                                style="text-decoration: none; background-color: #278cc2;color: #fff; padding: 10px 10px; display: block; text-align: center; border-radius: 3px;">ادفع
                                الان</a>
