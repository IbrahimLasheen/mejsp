                    ...
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">طلب حجز مؤتمر</h2>

                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right">نوع الشهادة</span>
                            ...
                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right">سعر الشهادة</span>
                                <span style="float: left">${{ $info['price'] }}</span>
                                <div style="clear: both;"></div>
                            </div>


                            @if ($info['research_title'] != null)
                                <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                    <span style="float: right">عنوان البحث</span>
                                    <span style="float: left">{{ $info['research_title'] }}</span>
                                    <div style="clear: both;"></div>
                                </div>
                            @endif
                            ...
                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right;">البريد الالكتروني</span>
