                            ...
                            <h2 style="color:#212121">{{ $info['mail_title'] }}    </h2>
                             ...
                             <p>{{ $info['mail_details1'] }} </p>
                               ...
                               <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                    <span style="float: right;color:#212121">سبب الحذف : </span>
                                    <span style="float: left">{{ $info['reason'] }}</span>
                                    <div style="clear: both;"></div>
                                </div>

                               
                                <a href="{{ env('APP_URL').'/u/researches/all' }}" style="margin-top:10px;background-color: #09c; color: #fff; text-decoration: none; padding: 10px; border-radius: 4px; display: block; text-align: center;">الانتقال للوحة التحكم </a>
