                            ...
                            <h2 style="color:#212121">{{ $info['mail_title'] }}    </h2>
                             ...
                             <p cla dir="rtl">{{ $info['mail_details1'] }} </p>
                               ...
                               @elseif($info['status'] == 5  )
                                    <a href="{{ env('APP_URL').'/admin/users/chat/'.$info['id'] }}" style="margin-top:10px;background-color: #09c; color: #fff; text-decoration: none; padding: 10px; border-radius: 4px; display: block; text-align: center;">عرض التعليقات   </a>
