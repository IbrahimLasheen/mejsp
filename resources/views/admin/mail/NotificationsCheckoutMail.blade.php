                    ...
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">فاتورة مدفوعة</h2>

                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right">سعر الفاتورة</span>
                            ...
                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right;">المصدر</span>
                                <span style="float: left;">{{ $info['source'] }}</span>
                                <div style="clear: both;"></div>
                            </div>


                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right;">بواسطة</span>
