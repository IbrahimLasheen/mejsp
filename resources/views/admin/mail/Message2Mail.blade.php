                    ...
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">  رد جديد على تعديل بحث  </h2>
                            
                            <h4>
                                قام مقدم بحث     
                                <a style="padding:4px 20px; background:#278cc2 !imortant; color:white !important;" href="{{ env('APP_URL').'/admin/users/chat/'.$info['id'] }}" > 
                                {{ $info['name']}}
                                </a>
                                بالرد على تعديل بحثه 
                                يمكنك الاطلاع عليها من 
                                 
                                <a style="padding:4px 20px; background:#278cc2 !imortant; color:white !important;" href="{{ env('APP_URL').'/admin/users/chat/'.$info['id'] }}" >   هنا   </a>
                            </h4>
